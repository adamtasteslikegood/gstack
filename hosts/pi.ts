...
/**
 * Pi host config.
 * Pi loads skills from ~/.pi/agent/skills/ (global) and .pi/skills/ (project).
 * Pi invokes skills as /skill:<name> rather than /<name>, so a host adapter
 * rewrites bare skill references in generated docs.
 */
const pi: HostConfig = {
  name: 'pi',
  displayName: 'Pi',
