/**
 * Pi host adapter — post-processing content transformer.
 *
 * Runs AFTER generic frontmatter/path/tool rewrites from the config system.
 * Pi invokes skills as /skill:<name> rather than /<name>, so rewrite bare
 * skill command references in generated docs.
 *
